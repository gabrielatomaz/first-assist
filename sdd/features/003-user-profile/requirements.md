...
* **Flow**:
  ...
  3. Displays current user's profile info (name, email, avatarIcon, avatarColor).
  4. User edits name, email, avatarIcon, or avatarColor and clicks "Save".
...
* **Avatar Fields**: `avatarIcon` (default `'user'`), `avatarColor` (default `'#4F7F82'`).
